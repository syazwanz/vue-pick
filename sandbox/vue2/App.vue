  ...
  <div style="padding: 2rem">
    ...
    <section>
      ...
      <div class="wrapper">
        ...
        <VPickNative id="status" v-model="selected" :options="status" placeholder="Select status" />
      </div>
    </section>
    ...
    <section>
      ...
      <div class="wrapper">
        ...
        <VPickNative id="dept" v-model="selectedGroup" :options="departments" placeholder="Select department" />
      </div>
    </section>
    ...
    <section>
      ...
      <div class="wrapper">
        ...
        <VPickNative id="default" :options="status" placeholder="Default" />
      </div>
      <div class="wrapper" style="margin-top: 10px">
        <label for="small" class="label">Small:</label><br />
        <VPickNative id="small" :options="status" placeholder="Small" size="sm" />
      </div>
    </section>

    <section>
      <h2 class="subject">Error</h2>
      <VPickNative v-model="selectedError" :options="status" placeholder="Select status"
    ...
    <section>
      ...
      <form class="wrapper" @submit.prevent="onSubmit">
        ...
        <VPickNative id="form-status" v-model="selectedForm" name="status" :options="status" placeholder="Select status"
          required />
