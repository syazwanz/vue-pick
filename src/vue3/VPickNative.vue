...
import { type OptionItem, isOptionGroup, normalizeOptions } from "../core"
...
<template>
  ...
  >
    ...
    <span
      v-if="loading"
      class="vpick-native-icon vpick-native-spinner"
      aria-hidden="true"
    >
      <slot name="loading">
        <svg
