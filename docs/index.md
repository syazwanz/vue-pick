...
hero:
  name: "Vue-Pick"
  tagline: "Select, multiselect, and tree select for Vue 2.7 and Vue 3, from one codebase."
  image:
    src: /hero.webp
    alt: VuePick
  actions:
    ...
    - theme: alt
      text: View on GitHub
      link: https://github.com/syazwanz/vue-pick

features:
  - title: Tree select
    details: Nested options with cascading parent and child selection.
    icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12h-8"/><path d="M21 18h-8"/><path d="M21 6h-8"/><path d="M3 6v4c0 1.1.9 2 2 2h3"/><path d="M3 10v6c0 1.1.9 2 2 2h3"/></svg>'
  - title: Native or custom
    details: A styled native select, or a full custom dropdown.
    icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="m16 10-4 4-4-4"/></svg>'
  - title: Vue 2.7 + Vue 3
  ...
  - title: Fully accessible
    ...
    icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="16" cy="4" r="1"/><path d="m18 19 1-7-5.87.94"/><path d="m5 8 3-3 5.5 3-2.21 3.1"/><path d="M4.24 14.48c-.19.58-.27 1.2-.23 1.84a5 5 0 0 0 5.31 4.67c2.76-.17 4.86-2.54 4.69-5.3"/></svg>'
  - title: Customizable
  ...
  - title: Zero dependencies
    details: No third-party runtime dependencies.
